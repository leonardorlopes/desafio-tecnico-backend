...
import { getCards, updateCard, removeCard, addCard } from '../services/cardServices';
...
const Board = () => {
    ...
    return (
        <BoardContainer>
            ...
            <Lista titulo={"To Do"}>
                {
                    Array.isArray(cards) ? cards.filter(c => c.lista === 'ToDo').map(c =>
                        <Card
                            key={c.id}
                            titulo={c.titulo}
                            conteudo={c.conteudo}
            ...
            <Lista titulo={"Doing"}>
                {
                    Array.isArray(cards) ? cards.filter(c => c.lista === 'Doing').map(c =>
                        <Card
                            key={c.id}
                            titulo={c.titulo}
                            conteudo={c.conteudo}
            ...
            <Lista titulo={"Done"}>
                {
                    Array.isArray(cards) ? cards.filter(c => c.lista === 'Done').map(c =>
                        <Card
                            key={c.id}
                            titulo={c.titulo}
                            conteudo={c.conteudo}
